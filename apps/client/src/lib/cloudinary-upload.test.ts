...
describe("uploadToCloudinary", () => {
  beforeEach(() => {
    // Vite exposes client config on import.meta.env; vi.stubEnv drives it.
    vi.stubEnv("VITE_CLOUDINARY_CLOUD_NAME", MOCK_CLOUD_NAME);
    vi.stubEnv("VITE_CLOUDINARY_UPLOAD_PRESET", MOCK_PRESET);
  });
  ...
  it("throws when VITE_CLOUDINARY_CLOUD_NAME is missing", async () => {
  ...
  it("throws when VITE_CLOUDINARY_UPLOAD_PRESET is missing", async () => {
